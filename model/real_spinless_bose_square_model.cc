...
int main(int argc, char* argv[])
{
    ...
    space = new RealSpinlessBoseSquareSpace(num_site_x, num_site_y, num_boson, physics_dim);
    hamiltonian = new RealSpinlessBoseSquareHamiltonian(num_site_x, num_site_y, physics_dim, flux_value, Jx, Jy, 
