#include "model/hamiltonian/complex_spinless_bose_square_hamiltonian.h"


ComplexSpinlessBoseSquareHamiltonian::ComplexSpinlessBoseSquareHamiltonian(int num_site_x, int num_site_y, int physics_dim, 
...
ComplexSpinlessBoseSquareHamiltonian::~ComplexSpinlessBoseSquareHamiltonian()
{

}

void ComplexSpinlessBoseSquareHamiltonian::DefineBasicTensor()
{
...
// a^+ a^-
void ComplexSpinlessBoseSquareHamiltonian::DefineHamiltonian1(int p1, int p2, double coefficient)
{
...
// a^- a^+
void ComplexSpinlessBoseSquareHamiltonian::DefineHamiltonian2(int p1, int p2, double coefficient)
{
    double operator_coefficient;
    int operator_index, operator_table[1];
...
// {\mu}n+{U}n(n-1)
void ComplexSpinlessBoseSquareHamiltonian::DefineHamiltonian3(int p, double coefficient)
{
    double operator_coefficient;
    int operator_index, operator_table[1];
...
void ComplexSpinlessBoseSquareHamiltonian::DefineTensorHamiltonian()
{
    int p[2];
