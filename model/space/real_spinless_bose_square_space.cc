...
RealSpinlessBoseSquareSpace::RealSpinlessBoseSquareSpace(int num_site_x, int num_site_y, int num_boson, int physics_dim)
{
    // derive class member
...
RealSpinlessBoseSquareSpace::~RealSpinlessBoseSquareSpace()
{

}

void RealSpinlessBoseSquareSpace::DefineQuantumTable()
{
    double mean_quantum;
...
void RealSpinlessBoseSquareSpace::MergeQuantumTable(int* merge_quantum_table, int* operator_quantum_table, 
