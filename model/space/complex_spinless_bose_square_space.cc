...
ComplexSpinlessBoseSquareSpace::ComplexSpinlessBoseSquareSpace(int num_site_x, int num_site_y, int num_boson, int physics_dim)
{
    // derive class member
...
ComplexSpinlessBoseSquareSpace::~ComplexSpinlessBoseSquareSpace()
{

}

void ComplexSpinlessBoseSquareSpace::DefineQuantumTable()
{
    double mean_quantum;
...
void ComplexSpinlessBoseSquareSpace::MergeQuantumTable(int* merge_quantum_table, int* operator_quantum_table, 
        int* space_quantum_table)
{
    merge_quantum_table[0] = operator_quantum_table[0] + space_quantum_table[0];
}

int ComplexSpinlessBoseSquareSpace::CheckQuantumTable(int site, int* left_table, int* right_table)
{
    int info = -1;
    (void)site;
