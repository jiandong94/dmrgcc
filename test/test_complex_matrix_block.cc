...
int main()
{
    ...
    // constructor
    ComplexMatrixBlock* matrix_block;
    matrix_block = new ComplexMatrixBlock();
    matrix_block->PrintMatrixBlock();
    delete matrix_block;

    // constructor
    matrix_block = new ComplexMatrixBlock(4);
    matrix_block->PrintMatrixBlock();
   
    ComplexMatrix* tmp_matrix = new ComplexMatrix(3,3);
    ...
    Complex* state = new Complex[matrix_block->ComputeMatrixBlockDim()];
    ...
    ComplexMatrixBlock* matrix_block_read = new ComplexMatrixBlock();
