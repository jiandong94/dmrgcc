...
{
    cout << "=================================" << endl;
    cout << "       Test ComplexTensorLattice    " << endl;
    cout << "=================================" << endl;
    
    cout << "1. Constructor" << endl;
    ComplexTensorLattice* tensor_lattice = new ComplexTensorLattice(2);
    ...
    ComplexTensorLattice* tensor_lattice_read = new ComplexTensorLattice();
    ...
    Complex* state = new Complex[tensor_lattice->ComputeKetTensorDim()];
