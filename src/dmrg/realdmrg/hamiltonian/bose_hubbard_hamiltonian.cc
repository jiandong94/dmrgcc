#include "dmrg/realdmrg/hamiltonian/bose_hubbard_hamiltonian.h"
...
void BoseHubbardHamiltonian::DefineBasicTensor()
{
...
// a^+ a^-
void BoseHubbardHamiltonian::DefineHamiltonian1(int p1, int p2, double coefficient)
{
...
// a^- a^+
void BoseHubbardHamiltonian::DefineHamiltonian2(int p1, int p2, double coefficient)
{
    double operator_coefficient;
    int operator_index, operator_table[1];
...
// {\mu}n+{U}n(n-1)
void BoseHubbardHamiltonian::DefineHamiltonian3(int p, double coefficient)
{
    double operator_coefficient;
    int operator_index, operator_table[1];
...
void BoseHubbardHamiltonian::DefineTensorHamiltonian()
{
    int p[2];
