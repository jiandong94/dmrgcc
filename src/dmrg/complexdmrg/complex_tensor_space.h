#ifndef DMRGCC_DMRG_COMPLEX_TENSOR_SPACE_H_
#define DMRGCC_DMRG_COMPLEX_TENSOR_SPACE_H_

#include "dmrg/complexdmrg/complex_tensor_lattice.h"

class ComplexTensorSpace
{
    ...
    // tensor lattice
    ComplexTensorLattice **tensor_lattice_;
    ...
    // expan lattice
    ComplexTensorLattice* expan_tensor_lattice_;

    public:
   
    // destructor
    //
    virtual ~ComplexTensorSpace();
    ...
    // 
    //
    ComplexTensorLattice* get_tensor_lattice(int site);
