...
ComplexTensorHamiltonian::~ComplexTensorHamiltonian()
{
...
ComplexTensorOperator* ComplexTensorHamiltonian::get_tensor_hamiltonian(int site)
{
    return tensor_hamiltonian_[site];
}

void ComplexTensorHamiltonian::PrintTensorHamiltonian()
{
...
void ComplexTensorHamiltonian::WriteTensorHamiltonian(const char* tensor_hamiltonian_name)
{
...
void ComplexTensorHamiltonian::WriteTensorHamiltonian(ofstream &tensor_hamiltonian_file)
{
...
void ComplexTensorHamiltonian::ReadTensorHamiltonian(const char* tensor_hamiltonian_name)
{
...
void ComplexTensorHamiltonian::ReadTensorHamiltonian(ifstream &tensor_hamiltonian_file)
{
    for(int i=0;i<num_site_pp_;++i)
    {
        for(int j=0;j<num_table_[i];++j) delete[] quantum_table_[i][j];
...
void ComplexTensorHamiltonian::ExpanTensorHamiltonian(int site, int expan_operator_index, Complex expan_coefficient, 
        int* expan_table)
{
...
void ComplexTensorHamiltonian::ParallelTensorHamiltonian()
{
...
void ComplexTensorHamiltonian::DefineTensorHamiltonian()
{
    error("Base class can not define tensor hamiltonian");
}

void ComplexTensorHamiltonian::DefineQuantumTable(int num_quantum)
{
...
void ComplexTensorHamiltonian::ParallelQuantumTable(int site, int num_unparallel, 
