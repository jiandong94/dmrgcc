...
ComplexTensorOperator::ComplexTensorOperator()
{
    physics_dim_ = 0;
...
ComplexTensorOperator::ComplexTensorOperator(int physics_dim)
{
...
ComplexTensorOperator::ComplexTensorOperator(ComplexMatrix* tmp_tensor, Complex coefficient)
{
    Complex element;
...
int ComplexTensorOperator::get_physics_dim()
{
    return physics_dim_;
}

int ComplexTensorOperator::get_left_bond()
{
    return left_bond_;
}

int ComplexTensorOperator::get_right_bond()
{
    return right_bond_;
}

void ComplexTensorOperator::PrintTensorOperator()
{
    cout << "==============================" << endl;
    cout << "ComplexTensorOperator: " << endl;
...
void ComplexTensorOperator::WriteTensorOperator(const char* tensor_operator_name)
{
...
void ComplexTensorOperator::WriteTensorOperator(ofstream &tensor_operator_file)
{
...
void ComplexTensorOperator::ReadTensorOperator(const char* tensor_operator_name)
{
...
void ComplexTensorOperator::ReadTensorOperator(ifstream &tensor_operator_file)
{
    ResetTensorOperator();
    ...
    for(int i=0;i<left_bond_;++i) 
    {
        tensor_operator_[i] = new ComplexMatrix* [right_bond_];
        for(int j=0;j<right_bond_;++j)
        {
            tensor_operator_[i][j] = new ComplexMatrix(physics_dim_, physics_dim_);
            tensor_operator_[i][j]->ReadMatrix(tensor_operator_file);
        }
    }
}

void ComplexTensorOperator::ExpanTensorOperator(ComplexMatrix** basic_operator, int leigh, 
        int expan_operator_index, Complex expan_coefficient)
{
    ComplexMatrix*** expan_tensor_operator;
    ...
    expan_tensor_operator = new ComplexMatrix** [expan_left_bond];
    for(int i=0;i<expan_left_bond;++i)
    {
        expan_tensor_operator[i] = new ComplexMatrix* [expan_right_bond];
        for(int j=0;j<expan_right_bond;++j)
        {
            expan_tensor_operator[i][j] = new ComplexMatrix(physics_dim_, physics_dim_);
        }
    }
...
void ComplexTensorOperator::LeftParallelTensorOperator(int &num_unparallel, int* &position_unparallel, 
        ComplexMatrix* &transfer_tensor)
{
    ComplexMatrix* reshape_tensor;
    Complex element;
    ...
    reshape_tensor = new ComplexMatrix(reshape_row, reshape_column);
...
void ComplexTensorOperator::RightParallelTensorOperator(int &num_unparallel, int* &position_unparallel, 
        ComplexMatrix* &transfer_tensor)
{
    ComplexMatrix* reshape_tensor;
    Complex element;
...
void ComplexTensorOperator::LeftMergeTensorOperator(int num_unparallel, ComplexMatrix* transfer_tensor)
{
    ComplexMatrix ***result_tensor_operator;
    Complex element, factor[2];
    int merge_dim;
    ...
    result_tensor_operator = new ComplexMatrix** [num_unparallel];
    for(int l=0;l<num_unparallel;++l)
    {
        result_tensor_operator[l] = new ComplexMatrix*[right_bond_];
        for(int r=0;r<right_bond_;++r)
            result_tensor_operator[l][r] = new ComplexMatrix(physics_dim_, physics_dim_);
    }
...
void ComplexTensorOperator::RightMergeTensorOperator(int num_unparallel, ComplexMatrix* transfer_tensor)
{
    ComplexMatrix ***result_tensor_operator;
    Complex element, factor[2];
    int merge_dim;
    ...
    result_tensor_operator = new ComplexMatrix** [left_bond_];
    for(int l=0;l<left_bond_;++l)
    {
        result_tensor_operator[l] = new ComplexMatrix*[num_unparallel];
...
bool ComplexTensorOperator::LeftCheckZero(int l, int p1)
{
    bool zero_flag = false;
    for(int r=0;r<right_bond_;++r)
        for(int p2=0;p2<physics_dim_;++p2)
        {
            if(Norm(tensor_operator_[l][r]->get_matrix_element(p1, p2)) > 1E-15)
            {
                zero_flag = true;
                break;
            }
...
bool ComplexTensorOperator::RightCheckZero(int r, int p2)
{
    bool zero_flag = false;
    for(int l=0;l<left_bond_;++l)
...
bool ComplexTensorOperator::MixedCheckZero(int l, int p2)
{
    bool zero_flag = false;
    for(int r=0;r<right_bond_;++r)
        for(int p1=0;p1<physics_dim_;++p1)
